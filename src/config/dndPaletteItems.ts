...
export const humanPaletteItems: PaletteItem[] = [
  ...
  // Nationality
  { baseId: 'human-us', emoji: '🇺🇸', label: 'US Citizen', type: 'human', data: { nationality: 'us-citizen' }, category: 'Nationality', detailedDescription: 'A citizen of the United States' },
